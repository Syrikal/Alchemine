...
import syric.alchemine.outputs.fire.blocks.FellfireBlock;
...
public class FellfireEffect implements AlchemicalEffect {
    ...
    public void detonate(UseOnContext context) {
        ...
        new PlacementSet(level).addPattern(pattern).cull(PlacementSet.AIR_ONLY).cull(PlacementSet.randomFilter(0.7F)).placeContextualFire((AbstractAlchemicalFireBlock) AlchemineBlocks.FELL_FIRE.get());

    }

    @Override
    public String toString() { return "Fellfire"; }
